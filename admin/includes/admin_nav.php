                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="posts_dropdown" class="collapse">
                            ...
                            <li>
                                <a href="post.php?source=add_posts">Add Posts</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="">
                        <a href="./product.php"><i class="fa fa-fw fa-file"></i>View All Products</a>
                    </li>
                    <li class="">
                        <a href="product.php?source=add_products"><i class="fa fa-fw fa-file"></i>Add Products</a>
                    </li>
